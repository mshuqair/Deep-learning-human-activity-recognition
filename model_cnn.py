...
from keras.layers import Input, Dense, Dropout, Conv1D, MaxPooling1D, GlobalAveragePooling1D
...
def func_model():
    ...
    layer_final = layer_global_pooling
    ...
    layer_output = Dense(units=output_shape, activation='softmax', kernel_initializer=kernel_initializer)(
        layer_dropout_3)
